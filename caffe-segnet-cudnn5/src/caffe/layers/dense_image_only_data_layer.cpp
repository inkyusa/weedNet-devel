...
#include "caffe/layers/dense_image_only_data_layer.hpp"
...
DenseImageOnlyDataLayer<Dtype>::~DenseImageOnlyDataLayer<Dtype>() {
  this->JoinPrefetchThread();
}

template <typename Dtype>
void DenseImageOnlyDataLayer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void DenseImageOnlyDataLayer<Dtype>::ShuffleImages() {
...
template <typename Dtype>
void DenseImageOnlyDataLayer<Dtype>::InternalThreadEntry() {
...
INSTANTIATE_CLASS(DenseImageOnlyDataLayer);
REGISTER_LAYER_CLASS(DenseImageOnlyData);
